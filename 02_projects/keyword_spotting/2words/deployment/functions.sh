...
function connect_board_and_deploy_script() {
 ...
 arduino-cli board attach ${boardpath} ./deployment/micro_speech_2words/micro_speech_2words.ino
 echo -e "\n \e[1mCompiling Model\e[0m\n ------------------------"
 arduino-cli compile ./deployment/micro_speech_2words/micro_speech_2words.ino
 echo -e " \e[1mUploading Model to Arduino\e[0m\n -----------------------------------"
 arduino-cli upload --verify ./deployment/micro_speech_2words/micro_speech_2words.ino
 echo -e "\n -- DONE!\n"
}
