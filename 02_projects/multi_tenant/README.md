# **Project: Combine Keyword Spotting and Person Detection**
The scope in this project is to detect the keyword "yes" and also if a person is in front of the device via camera module.
